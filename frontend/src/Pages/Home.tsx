    ...
    <div className="">
      <div className="bg-lime-500 w-full rounded-3xl">
        <div className="w-full">
          <h1 className="text-lime-900 text-[18vw] font-bold text-center">
            Pharmacy
          </h1>
        </div>
        <h4 className="text-center lg:text-left lg:px-16 pb-12">
        ...
        <div className="justify-center lg:justify-start lg:px-16 flex items-center gap-10 pb-24">
